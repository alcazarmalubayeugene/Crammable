  ...
  return (
    <div
      ...
      style={{
        ...
        zIndex: 100,
        maxWidth: 360,
        background: toast.tone === "success" ? "var(--success-bg)" : "var(--error-bg)",
        border: `1.5px solid ${toast.tone === "success" ? "var(--success)" : "var(--error)"}`,
        color: toast.tone === "success" ? "var(--success-dark)" : "var(--error-dark)",
        borderRadius: 12,
        padding: "14px 18px",
