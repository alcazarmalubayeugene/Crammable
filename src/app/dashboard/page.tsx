    ...
    <main style={{ minHeight: "100vh", background: "var(--bg)", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 40 }}>
          <Link href={Routes.rewards} className="anim-fade-up-1 hover-lift" style={{ background: "var(--bg-card)", border: "1.5px solid var(--border)", borderRadius: 14, padding: "22px", display: "flex", alignItems: "center", gap: 18, textDecoration: "none" }}>
            <div style={{ width: 56, height: 56, borderRadius: 14, overflow: "hidden" }}>
              <Image src="/capy/capycoin.png" alt="" width={56} height={56} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "var(--font-display, serif)", fontSize: "calc(32px * var(--font-scale))", fontWeight: 700, color: "var(--text)", lineHeight: 1 }}>
                {profile?.token_balance ?? 0}
              </div>
              <div style={{ fontSize: "calc(13.5px * var(--font-scale))", color: "var(--text-muted)", marginTop: 4 }}>Capycoins remaining</div>
            </div>
            <span style={{ fontSize: "calc(13px * var(--font-scale))", fontWeight: 600, color: "var(--primary)", whiteSpace: "nowrap" }}>Earn more →</span>
          </Link>
          ...
          {isPro ? (
            <div className="anim-fade-up-3 hover-lift" style={{ background: "var(--bg-card)", border: "1.5px solid var(--border)", borderRadius: 14, padding: "16px", display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: "var(--font-display, serif)", fontSize: "calc(20px * var(--font-scale))", fontWeight: 700, color: "var(--text)", lineHeight: 1 }}>
                  Pro
                </div>
